---
name: documents-core-service
description: "Neutral documents primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/documents-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/documents-core-service/Requirements.md
---

# documents-core-service - Agent Contract

> Neutral primitives for documents (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic documents primitives reused by `personal-documents-service` + `business-documents-service` and any future overlay. Owns canonical documents contracts, events, storage shape. 
