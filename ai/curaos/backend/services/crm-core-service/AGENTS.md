...
description: "Neutral crm primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/crm-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/crm-core-service/Requirements.md
---

# crm-core-service - Agent Contract

> Neutral primitives for crm (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic crm primitives reused by `personal-crm-service` + `business-crm-service` and any future overlay. Owns canonical crm contracts, events, storage shape. 
...
overlay_consumers:
  - personal-crm-service
  - business-crm-service
notable:
