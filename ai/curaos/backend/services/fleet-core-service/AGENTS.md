---
name: fleet-core-service
description: "Neutral fleet primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/fleet-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/fleet-core-service/Requirements.md
---

# fleet-core-service - Agent Contract

> Neutral primitives for fleet (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic fleet primitives reused by `personal-fleet-service` + `business-fleet-service` and any future overlay. Owns canonical fleet contracts, events, storage shape. 
