---
name: integrations-core-service
description: "Neutral integrations primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/integrations-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/integrations-core-service/Requirements.md
---

# integrations-core-service - Agent Contract

> Neutral primitives for integrations (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic integrations primitives reused by `personal-integrations-service` + `business-integrations-service` and any future overlay. Owns canonical integrations contracts, events, storage shape. 
