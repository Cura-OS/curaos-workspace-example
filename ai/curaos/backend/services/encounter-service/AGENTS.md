...
description: "Neutral encounter primitives (FHIR R4 Encounter lifecycle (admit→discharge) + EpisodeOfCare, Flowable-gated transitions, outbox events) - healthstack baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/encounter-service/CONTEXT.md
  requirements: ai/curaos/backend/services/encounter-service/Requirements.md
---

# encounter-service - Agent Contract
...
Provide vertical-agnostic encounter primitives and any future overlay. Owns canonical encounter contracts, events, storage shape. - PHI boundary: never persist PHI outside this service's overlay schema (HIPAA).
