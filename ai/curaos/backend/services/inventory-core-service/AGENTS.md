...
description: "Neutral inventory primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/inventory-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/inventory-core-service/Requirements.md
---

# inventory-core-service - Agent Contract

> Neutral primitives for inventory (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic inventory primitives reused by `personal-inventory-service` + `business-inventory-service` and any future overlay. Owns canonical inventory contracts, events, storage shape. 
