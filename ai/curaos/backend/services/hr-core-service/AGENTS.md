...
description: "Neutral hr primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/hr-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/hr-core-service/Requirements.md
---

# hr-core-service - Agent Contract

> Neutral primitives for hr (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic hr primitives reused by `personal-hr-service` + `business-hr-service` and any future overlay. Owns canonical hr contracts, events, storage shape. 
