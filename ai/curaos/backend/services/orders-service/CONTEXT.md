...
write-surface DTO (`src/.../orders.dto.ts`) — use them, never hand-roll
`z.number().int()`:
...
- APIs: REST `/api/v1/orders` (TBD path conventions)
## Open Questions
...
- `ai/curaos/backend/services/orders-service/Requirements.md` — full spec
