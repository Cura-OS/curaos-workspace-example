---
name: sales-core-service
description: "Neutral sales primitives (TBD) - neutral baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/sales-core-service/CONTEXT.md
  requirements: ai/curaos/backend/services/sales-core-service/Requirements.md
---

# sales-core-service - Agent Contract

> Neutral primitives for sales (TBD). Domain overlay: `neutral`.
## Mission

Provide vertical-agnostic sales primitives reused by `personal-sales-service` + `business-sales-service` and any future overlay. Owns canonical sales contracts, events, storage shape. 
