...
description: "Neutral scheduling primitives (FHIR R4 Appointment/Slot booking over neutral calendar-core + encounter materialization) - healthstack baseline."
...
docs:
  ...
  context: ai/curaos/backend/services/scheduling-service/CONTEXT.md
  requirements: ai/curaos/backend/services/scheduling-service/Requirements.md
---

# scheduling-service - Agent Contract

> Neutral primitives for scheduling (FHIR R4 Appointment/Slot booking over neutral calendar-core + encounter materialization). Domain overlay: `healthstack`.
## Mission

Provide vertical-agnostic scheduling primitives and any future overlay. Owns canonical scheduling contracts, events, storage shape. - PHI boundary: never persist PHI outside this service's overlay schema (HIPAA).
