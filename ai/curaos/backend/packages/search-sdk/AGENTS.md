---
name: curaos-search-sdk
description: "Typed search-service client - REST operations + request/response types generated from search.tsp (TypeSpec → OpenAPI 3.1 → @hey-api/openapi-ts), plus event wire-types from search.asyncapi.yaml. Generated from the notify-sdk recipe (M10 #278-284)."
tags: [package, sdk]
language: typescript
framework: none
...
npm: "@curaos/search-sdk"
target: isomorphic
milestone: M10
story: "your-org/curaos-ai-workspace#280"
...
# @curaos/search-sdk - agent contract

Horizontal SDK package. Typed client for `search-service` (OpenSearch cross-service + ParadeDB single-domain), generated from its
...
- **Generated code is committed under `src/`; `dist/` is the published build.**
  ...
  `bun run generate`. Edit the SERVICE contract (`search.tsp` /
  `search.asyncapi.yaml`) or the generator scripts, then regenerate.
