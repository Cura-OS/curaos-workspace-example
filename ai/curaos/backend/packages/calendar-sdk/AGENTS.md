---
name: curaos-calendar-sdk
description: "Typed calendar-core-service client - REST operations + request/response types generated from calendar.tsp (TypeSpec → OpenAPI 3.1 → @hey-api/openapi-ts), plus event wire-types from calendar.asyncapi.yaml. Generated from the notify-sdk recipe (M10 #278-284)."
tags: [package, sdk]
language: typescript
framework: none
...
npm: "@curaos/calendar-sdk"
target: isomorphic
milestone: M10
story: "your-org/curaos-ai-workspace#283"
...
# @curaos/calendar-sdk - agent contract

Horizontal SDK package. Typed client for `calendar-core-service` (iCalendar VEVENT + recurrence), generated from its
...
- **Generated code is committed under `src/`; `dist/` is the published build.**
  ...
  `bun run generate`. Edit the SERVICE contract (`calendar.tsp` /
  `calendar.asyncapi.yaml`) or the generator scripts, then regenerate.
