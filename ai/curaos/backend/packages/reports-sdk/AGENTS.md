---
name: curaos-reports-sdk
description: "Typed reports-service client - REST operations + request/response types generated from reports.tsp (TypeSpec → OpenAPI 3.1 → @hey-api/openapi-ts), plus event wire-types from reports.asyncapi.yaml. Generated from the notify-sdk recipe (M10 #278-284)."
tags: [package, sdk]
language: typescript
framework: none
...
npm: "@curaos/reports-sdk"
target: isomorphic
milestone: M10
story: "your-org/curaos-ai-workspace#282"
...
# @curaos/reports-sdk - agent contract

Horizontal SDK package. Typed client for `reports-service` (Gotenberg PDF + Superset embedded), generated from its
...
- **Generated code is committed under `src/`; `dist/` is the published build.**
  ...
  `bun run generate`. Edit the SERVICE contract (`reports.tsp` /
  `reports.asyncapi.yaml`) or the generator scripts, then regenerate.
